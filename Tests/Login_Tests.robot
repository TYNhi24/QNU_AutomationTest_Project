...
*** Test Cases ***
TC-024: Verify Successful Login With Valid Credentials
    [Documentation]    Kiểm tra đăng nhập thành công với tài khoản đúng
    Login To System    4551050152    1521050455
    Verify Login Success

TC-025: Verify Error Message When Username Is Empty
...
TC-026: Verify Error Message When Password Is Empty
...
TC-027: Verify Error Message For Invalid Username
...
TC-028: Verify Error Message For Invalid Password
    [Documentation]    Kiểm tra lỗi khi nhập sai mật khẩu
    Login To System    4551050152    wrong_pass
    Verify Login Error Message    ${MSG_INVALID_AUTH}
TC-029: Verify Error Message For Both Username And Password Empty
